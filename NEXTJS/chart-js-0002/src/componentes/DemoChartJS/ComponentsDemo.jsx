...
import { RenderizarComponentes_v2 } from '@/renderizar/RenderizarComponentes_v2'; 
...
export const ComponentsDemo = (prop) => {
    ...
    return (
        <>
            {
                data.map((item, index) => 
                    // Usar el índice como key puede ser apropiado para listas estáticas que no cambian
                    <React.Fragment key={index}>
                        {RenderizarComponentes_v2(item, { additionalProp: 'value' })}
                    </React.Fragment>
                )
            }
        </>
